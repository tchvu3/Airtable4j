...
import com.avihu.airtable4j.model.get.external.AirtableRecordGetFieldResponseFactory;
import com.avihu.airtable4j.model.update.internal.input.AirtableInitialRecordUpdateResponse;
...
public class AirtableRecordUpdateResponse {

    private String id;
    private String createdTime;
    private Map<String, AirtableRecordGetFieldResponse<?>> fields;

    public AirtableRecordUpdateResponse(AirtableInitialRecordUpdateResponse initial) {
